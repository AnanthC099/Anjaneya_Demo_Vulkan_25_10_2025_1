...
const char *images[] = {"images/right.png", "images/left.png", "images/top.png", "images/bottom.png", "images/front.png", "images/back.png"};
...
static DWORD gPanDurationMs     = 1200;      // computed for each pan
...
static const char* gOverlayPaths[kOverlayCount] = {
    "images/01_Mesh.png","images/02_Vrushabh.png","images/03_Mithun.png","images/04_Karka.png",
    "images/05_Simha.png","images/06_Kanya.png","images/07_Tula.png","images/08_Vruschik.png",
    "images/09_Dhanu.png","images/10_Makar.png","images/11_Kumbh.png","images/12_Meen.png"
};
...
VkResult initialize(void)
{
	...
	if (vkResult != VK_SUCCESS)
        {
                fprintf(gpFILE, "initialize() -> createTexture2D(images/01_Mesh.png) failed %d\n", vkResult);
		return vkResult;
	}
        else
        {
                fprintf(gpFILE, "initialize() ->  createTexture2D(images/01_Mesh.png) for kundali Succeeded\n");
		fflush(gpFILE);
	}
	...
	vkResult = createTexture2D(
        ...
        if (vkResult != VK_SUCCESS)
        {
                fprintf(gpFILE, "initialize() -> createTexture2D(%s) failed (%d), trying fallback images/02_Vrushabh.png\n", gOverlayTexPath2, vkResult);
	}
	else
	{
